    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/60 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
          <NavLink to="/" className="text-2xl font-semibold text-gradient">FinSim</NavLink>
          <nav className="flex items-center gap-8 text-base text-neutral-300">
      ...
      <footer className="border-t border-white/10 mt-20">
        <div className="mx-auto max-w-7xl px-6 py-10 text-base text-neutral-400">
